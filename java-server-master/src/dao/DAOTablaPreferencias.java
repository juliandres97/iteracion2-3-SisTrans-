...
public class DAOTablaPreferencias {
	 ...
	 */
	public void addPreferencia(Cliente cliente, Genero genero) throws SQLException {
		// TODO Auto-generated method stub
		String insertIntoPREFERENCIAS = "INSERT INTO ISIS2304B031710.PREFERENCIAS VALUES (?,?)";
		PreparedStatement prepStmt = conn.prepareStatement(insertIntoPREFERENCIAS);
		prepStmt.setInt(1, cliente.getId());
		prepStmt.setInt(2, genero.getId());
