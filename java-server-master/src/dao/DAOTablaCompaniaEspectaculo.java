...
public class DAOTablaCompaniaEspectaculo {
	/**
	 ...
	 */
	public DAOTablaCompaniaEspectaculo() {
	 ...
	 */
	public void addCompaniaToEspectaculo(int idCompania, int idEspectaculo) throws SQLException, Exception {
		// TODO Auto-generated method stub
		String insertIntoCOMPANIA_ESPECTACULO = "INSERT INTO ISIS2304B031710.COMPANIA_ESPECTACULO VALUES (?,?)";
		PreparedStatement innerPrepStmt = conn.prepareStatement(insertIntoCOMPANIA_ESPECTACULO);
		innerPrepStmt.setInt(1, idCompania);
		innerPrepStmt.setInt(2, idEspectaculo);
