...
DROP TABLE CLIENTES;
DROP TABLE STAFF;
DROP TABLE FUNCIONES_CANCELADAS;
DROP TABLE REALIZACION_FUNCIONES;
...
INSERT INTO "ISIS2304B031710"."LOCALIDADES" (ID, NOMBRE) VALUES ('1', 'vip');
INSERT INTO "ISIS2304B031710"."LOCALIDADES" (ID, NOMBRE) VALUES ('2', 'platea');
INSERT INTO "ISIS2304B031710"."LOCALIDADES" (ID, NOMBRE) VALUES ('3', 'platea lateral');
INSERT INTO "ISIS2304B031710"."LOCALIDADES" (ID, NOMBRE) VALUES ('4', 'platea posterior');
INSERT INTO "ISIS2304B031710"."LOCALIDADES" (ID, NOMBRE) VALUES ('5', 'platea posterior lateral');
INSERT INTO "ISIS2304B031710"."LOCALIDADES" (ID, NOMBRE) VALUES ('6', 'balcon');
INSERT INTO "ISIS2304B031710"."LOCALIDADES" (ID, NOMBRE) VALUES ('7', 'palco');
...
CREATE TABLE "ISIS2304B031710"."FUNCIONES" 
   ("ID" NUMBER, 
	...
	"DIA_REALIZACION" DATE NOT NULL ENABLE, 
	 CONSTRAINT "FUNCIONES_PK" PRIMARY KEY ("ID", "ID_ESPECTACULO", "ID_SITIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
CREATE TABLE "ISIS2304B031710"."ESPECTADORES" 
	...
	"ID_CLIENTE" NUMBER NOT NULL ENABLE, 
	 CONSTRAINT "ESPECTADORES_PK" PRIMARY KEY ("ID_ESPECTACULO", "ID_FUNCION", "ID_CLIENTE")
  USING INDEX (CREATE UNIQUE INDEX "ISIS2304B031710"."ESPECTADORES_PK1" ON "ISIS2304B031710"."ESPECTADORES" ("ID_ESPECTACULO", "ID_FUNCION", "ID_CLIENTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  TABLESPACE "TBSPROD" )  ENABLE, 
	 CONSTRAINT "ESPECTADORES_FK1" FOREIGN KEY ("ID_FUNCION", "ID_ESPECTACULO", "ID_SITIO")
	  REFERENCES "ISIS2304B031710"."FUNCIONES" ("ID", "ID_ESPECTACULO", "ID_SITIO") ON DELETE CASCADE ENABLE, 
...
--  DDL ABONADOS
--------------------------------------------------------
  CREATE TABLE "ISIS2304B031710"."ABONADOS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"ID_CLIENTE" NUMBER NOT NULL ENABLE, 
	 CONSTRAINT "ABONADOS_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  TABLESPACE "TBSPROD"  ENABLE, 
	 CONSTRAINT "ABONADOS_FK1" FOREIGN KEY ("ID_CLIENTE")
	  REFERENCES "ISIS2304B031710"."CLIENTES" ("ID") ON DELETE CASCADE ENABLE
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS NOLOGGING
...
CREATE TABLE "ISIS2304B031710"."BOLETAS" 
  ...
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 NOLOGGING 
  TABLESPACE "TBSPROD"  ENABLE, 
	 --CONSTRAINT "BOLETAS_UK1" UNIQUE ("ID_ABONO")
  --USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  --TABLESPACE "TBSPROD"  ENABLE, 
	 CONSTRAINT "BOLETAS_FK1" FOREIGN KEY ("ID_FUNCION", "ID_ESPECTACULO", "ID_SITIO")
	  REFERENCES "ISIS2304B031710"."FUNCIONES" ("ID", "ID_ESPECTACULO", "ID_SITIO") ON DELETE CASCADE ENABLE, 
	 CONSTRAINT "BOLETAS_FK3" FOREIGN KEY ("ID_ABONO")
	  REFERENCES "ISIS2304B031710"."ABONADOS" ("ID") ON DELETE CASCADE ENABLE
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS NOLOGGING
  TABLESPACE "TBSPROD" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "TBSPROD"  ENABLE, 
	 ...
	 CONSTRAINT "CUPOS_FK1" FOREIGN KEY ("ID_FUNCION", "ID_ESPECTACULO", "ID_SITIO")
	  REFERENCES "ISIS2304B031710"."FUNCIONES" ("ID", "ID_ESPECTACULO", "ID_SITIO") ON DELETE CASCADE ENABLE, 
	 CONSTRAINT "CUPOS_FK2" FOREIGN KEY ("ID_SITIO")
	  REFERENCES "ISIS2304B031710"."SITIOS" ("ID") ON DELETE CASCADE ENABLE
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS NOLOGGING
...
--------------------------------------------------------
--  DDL REALIZACION_FUNCIONES
-- CREATE TABLE "ISIS2304B031710"."REALIZACION_FUNCIONES" 
   ("ID_FUNCION" NUMBER NOT NULL ENABLE, 
	"ID_ESPECTACULO" NUMBER NOT NULL ENABLE,
  "ID_SITIO" NUMBER NOT NULL ENABLE,
	"REALIZADO" VARCHAR2(1 BYTE) NOT NULL ENABLE, 
	 CONSTRAINT "REALIZACION_FUNCIONES_PK" PRIMARY KEY ("ID_FUNCION", "ID_ESPECTACULO", "ID_SITIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "TBSPROD"  ENABLE, 
	 CONSTRAINT "REALIZACION_FUNCIONES_CHK1" CHECK (REALIZADO IN ('s','n')) ENABLE, 
	 CONSTRAINT "REALIZACION_FUNCIONES_FK1" FOREIGN KEY ("ID_FUNCION", "ID_ESPECTACULO", "ID_SITIO")
	  REFERENCES "ISIS2304B031710"."FUNCIONES" ("ID", "ID_ESPECTACULO", "ID_SITIO") ON DELETE CASCADE ENABLE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS NOLOGGING
...
--------------------------------------------------------
--  DDL FUNCIONES_CANCELADAS
--------------------------------------------------------
  CREATE TABLE "ISIS2304B031710"."FUNCIONES_CANCELADAS" 
   (	"ID_FUNCION" NUMBER NOT NULL ENABLE, 
	"ID_ESPECTACULO" NUMBER NOT NULL ENABLE, 
	"ID_SITIO" NUMBER NOT NULL ENABLE, 
	 CONSTRAINT "FUNCIONES_CANCELADAS_PK" PRIMARY KEY ("ID_FUNCION", "ID_ESPECTACULO", "ID_SITIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 NOLOGGING 
  TABLESPACE "TBSPROD"  ENABLE
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
