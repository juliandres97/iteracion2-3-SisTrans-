...
(
  ...
  CONSTRAINT STAFF_ROL_IN CHECK (ROL IN ('administrador', 'operario'))
);
...
(
  ...
  NIT_COMPANIA VARCHAR2(255 BYTE) COMPANIAS_NIT_NN NOT NULL,
  ...
  CONSTRAINT COMPANIAS_NIT_UN UNIQUE (NIT),
  CONSTRAINT COMPANIAS_SALIDA_CK CHECK (SALIDA >= LLEGADA)
);
...
INSERT INTO STAFF VALUES (1, '1', 'Julian', '123', 'julian@festivandes.com', 'administrador');
