...
CREATE TABLE "ISIS2304B031710"."ESPECTADORES" 
  ...
  USING INDEX (CREATE UNIQUE INDEX "ISIS2304B031710"."ESPECTADORES_PK1" ON "ISIS2304B031710"."ESPECTADORES" ("ID_ESPECTACULO", "ID_CLIENTE", "ID_FUNCION") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  TABLESPACE "TBSPROD" )  ENABLE, 
	 CONSTRAINT "ESPECTADORES_FK1" FOREIGN KEY ("ID_CLIENTE")
	  REFERENCES "ISIS2304B031710"."CLIENTES" ("ID") ON DELETE CASCADE ENABLE, 
	 CONSTRAINT "ESPECTADORES_FK2" FOREIGN KEY ("ID_ESPECTACULO")
	  REFERENCES "ISIS2304B031710"."ESPECTACULOS" ("ID") ON DELETE CASCADE ENABLE, 
	 CONSTRAINT "ESPECTADORES_FK3" FOREIGN KEY ("ID_FUNCION")
 ...
 NOCOMPRESS NOLOGGING
  ...
  CREATE UNIQUE INDEX "ISIS2304B031710"."ESPECTADORES_PK" ON "ISIS2304B031710"."ESPECTADORES" ("ID_ESPECTACULO", "ID_CLIENTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS NOLOGGING 
  TABLESPACE "TBSPROD";
...
CREATE TABLE "ISIS2304B031710"."BOLETAS" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	"ID_ESPECTCULO" NUMBER NOT NULL ENABLE, 
	"ID_FUNCION" NUMBER NOT NULL ENABLE, 
	"ID_SITIO" NUMBER NOT NULL ENABLE, 
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "TBSPROD"  ENABLE, 
	 CONSTRAINT "BOLETAS_FK1" FOREIGN KEY ("ID_ESPECTCULO")
	  REFERENCES "ISIS2304B031710"."ESPECTACULOS" ("ID") ENABLE, 
	 CONSTRAINT "BOLETAS_FK2" FOREIGN KEY ("ID_FUNCION")
	  REFERENCES "ISIS2304B031710"."FUNCIONES" ("ID") ENABLE, 
	 CONSTRAINT "BOLETAS_FK3" FOREIGN KEY ("ID_SITIO")
...
CREATE TABLE "ISIS2304B031710"."CUPOS" 
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "TBSPROD"  ENABLE, 
	 CONSTRAINT "CUPOS_CUPO_CK" CHECK (CUPO >= 0) ENABLE, 
	 CONSTRAINT "CUPOS_FK1" FOREIGN KEY ("ID_ESPECTACULO")
	  REFERENCES "ISIS2304B031710"."ESPECTACULOS" ("ID") ON DELETE CASCADE ENABLE, 
	 CONSTRAINT "CUPOS_FK2" FOREIGN KEY ("ID_FUNCION")
	  REFERENCES "ISIS2304B031710"."FUNCIONES" ("ID") ON DELETE CASCADE ENABLE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS NOLOGGING
